...
describe('handlers', function () {
    ...
    it('should handle all trades correctly', function () {
      ...
      return standingsRequest.then(topTeams => {
        ...
        topTeams.should.eql([{owner: 'Celtics', from: 'Nets'}, {owner: 'Suns', from: 'Suns'},
          {owner: 'Lakers', from: 'Lakers'}, {owner: '76ers', from: '76ers'}, {owner: 'Magic', from: 'Magic'},
          ...
          {owner: 'Thunder', from: 'Thunder'}, {owner: 'Nets', from: 'Wizards'}, {owner: 'Jazz', from: 'Jazz'},
          {owner: 'Raptors', from: 'Clippers'}, {owner: 'Magic', from: 'Raptors'}, {owner: 'Trail Blazers', from: 'Cavaliers'},
  ...
  describe('#_numericalOutput', function () {
    ...
    it('should add newline + index to each string in array', function () {
      ...
      teamsThe.should.eql(['1. Celtics (from the Nets)', '2. Suns', '3. Lakers', '4. 76ers']);
    });
  });
});
