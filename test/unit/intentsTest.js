...
describe('Intents', function () {
  it('should have GET_TANK_STANDINGS intent with value GetTankStandings', function () {
    intents.GET_TANK_STANDINGS.should.equal('GetTankStandings');
  });
  ...
  it('should have GET_TOP_N_TANK_STANDINGS intent with value GetTopNTankStandings', function () {
    intents.GET_TOP_N_TANK_STANDINGS.should.equal('GetTopNTankStandings');
  });

  it('should have GET_TEAM_STANDINGS intent with value GetTeamStandings', function () {
    intents.GET_TEAM_STANDINGS.should.equal('GetTeamStandings');
  });
